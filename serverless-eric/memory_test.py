...
# CIFAR-100 labels (same as your original code)
CIFAR100_LABELS = {
...
def test_prediction(image_path):
    """Test function that loads model and makes a prediction"""
    # Load model (this will show memory increase)
    model = load_model()
    ...
    print(f"Prediction: {CIFAR100_LABELS[predicted.item()]} (class {predicted.item()})")
...
if __name__ == "__main__":
    ...
    image_path = "plane.jpg"  # change this to your test image path
